"""Faça um programa que peça o tamanho de um arquivo para download (em MB) e a velocidade de um link de Internet (em Mbps), calcule
...
print(f"Tempo aproximado de download: {tempo} Minutos")